class Cl_photographe {
 // !!  tags est un tableau, ex: ["sport", "fashion", "events", "animals"]
    ...
    // retourne le nombre de like et le tarif d'un photographe pour la page de détail
    get infosDetailAutrePhotographe() {
        return `<section class="detail-photographe__infos-autres">
            ...
            <p class="detail-photographe__infos-autres__aside__total-likes" aria-label="Nombre de like : ${this.userReloadLikes}" tabindex="6">${this.userReloadLikes}</p>
